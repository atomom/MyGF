...
//						TargetEvent.Register(this, "Hello", MyMethod);				// no arguments, no return value
//						TargetEvent<int, string>.Register(this, "Hello", MyMethod);	// 2 arguments, no return value
//						TargetEventReturn<int, string, float, bool>.Register(this, "Hello", MyMethod);	// 3 arguments + return value
//
//					triggering the event from another object:
//						TargetEvent.Send(someObject, "Hello");						// no arguments, no return value
//						TargetEvent<int, string>.Send(someObject, "Hello", 242, "blabla");	// 2 arguments, no return value
//						bool result = TargetEventReturn<int, bool>.Send(someObject, "Hello", 242);	// 1 argument + return value
//
//					FURTHER NOTES:
//
...
//					by default).
//
//					4) setting the optional 'TargetEventOptions' parameter to 'RequireReceiver'
...
namespace IUV.SDN
{
    public enum TargetEventOptions
    {
    ...
    internal static class TargetEventHandler
    {
        ...
        /// use 'TargetEvent.Register' or 'TargetEventReturn.Register'.
        ...
        public static void Register(object target, string eventName, Delegate callback, int dictionary)
        {
            ...
            if (target == null)
            {
                Log.Warning(" -> TargetEvent.Register) Target object is null.");
                return;
            }
            if (string.IsNullOrEmpty(eventName))
            {
                Log.Warning(" - > TargetEvent.Register) Event name is null or empty.");
                return;
            }
            if (callback == null)
            {
                Log.Warning(" - > TargetEvent.Register) Callback is null.");
                return;
            }
            if (callback.Method.Name.StartsWith(" < ")) { Log.Warning(" - > TargetEvent.Register) Target events can only be registered to declared methods."); return; }
        ...
        /// events, use 'TargetEvent&lt&gt.Unregister' or
        /// 'TargetEventReturn&lt&gt.Unregister'. To unregister all events,
        /// use 'TargetEventHandler.UnregisterAll'. (this method unregisters
        ...
        /// instead use 'TargetEvent.Register' or 'TargetEventReturn.Register'.
        /// (this method looks for an event name registered to the target object and
        /// - if found - returns the delegate.)
        /// </summary>
        public static Delegate GetCallback(object target, string eventName, bool upwards, int d, TargetEventOptions options)
        {
#if UNITY_EDITOR
            if (string.IsNullOrEmpty(eventName))
            {
                Log.Warning(") TargetEvent.Send : Name is null or empty.");
                return null;
            }
#endif
            ...
            if (!((options & TargetEventOptions.IncludeInactive) == TargetEventOptions.IncludeInactive))
            {
        ...
        /// </summary>
        public static void OnNoReceiver(string eventName, TargetEventOptions options)
        {
            if (!((options & TargetEventOptions.RequireReceiver) == TargetEventOptions.RequireReceiver))
                return;
            Log.Error(") TargetEvent '" + eventName + "'has no receiver!");
        }
    ...
    /// (1 generic argument).
    /// </summary>
    public static class TargetEvent<T>
    {

        /// <summary>
        /// registers a callback (method or delegate) with the target object.
        /// the callback can be triggered later by sending the event 'eventName'.
        /// example signature: 'TargetEvent&ltfloat&gt.Register'
        /// </summary>
        public static void Register(object target, string eventName, Action<T> callback)
        {
            TargetEventHandler.Register(target, eventName, (Delegate) callback, 1);
        }
        ...
        /// 'TargetEventOptions.RequireReceiver' there will be an error if
        /// no such callback can be found.
        /// example signature: 'TargetEvent&lt;int&gt;.Send'
        /// </summary>
        public static void Send(object target, string eventName, T arg, TargetEventOptions options = TargetEventOptions.DontRequireReceiver)
        {
            retry : Delegate callback = TargetEventHandler.GetCallback(target, eventName, false, 1, options);
            if (callback == null)
            {
                TargetEventHandler.OnNoReceiver(eventName, options);
                return;
        ...
        /// example signature: 'TargetEvent&lt;int&gt;.SendUpwards'. NOTES:
        /// 1) only the first matching callback detected will execute. The event will fail
        /// if the scan reaches the scene root with no match found. 2) it is best to register
        /// _transforms_ and not other types of component for use with 'SendUpwards', since
        ...
        /// correct component.
        /// </summary>
        public static void SendUpwards(Component target, string eventName, T arg, TargetEventOptions options = TargetEventOptions.DontRequireReceiver)
        {
            retry : Delegate callback = TargetEventHandler.GetCallback(target, eventName, true, 1, options);
            if (callback == null)
            {
                TargetEventHandler.OnNoReceiver(eventName, options);
                return;
    ...
    /// (2 generic arguments).
    /// </summary>
    public static class TargetEvent<T, U>
    {

        /// <summary>
        /// registers a callback (method or delegate) with the target object.
        /// the callback can be triggered later by sending the event 'eventName'.
        /// example signature: 'TargetEvent&ltstring, string&gt.Register'
        /// </summary>
        public static void Register(object target, string eventName, Action<T, U> callback)
        {
            TargetEventHandler.Register(target, eventName, (Delegate) callback, 2);
        }
        ...
        /// 'TargetEventOptions.RequireReceiver' there will be an error if
        /// no such callback can be found.
        /// example signature: 'TargetEvent&lt;int, bool&gt;.Send'
        /// </summary>
        public static void Send(object target, string eventName, T arg1, U arg2, TargetEventOptions options = TargetEventOptions.DontRequireReceiver)
        {
            retry : Delegate callback = TargetEventHandler.GetCallback(target, eventName, false, 2, options);
            if (callback == null)
            {
                TargetEventHandler.OnNoReceiver(eventName, options);
                return;
            ...
            try
            {
                ((Action<T, U>) callback).Invoke(arg1, arg2);
            }
            catch { eventName += "_"; goto retry; }
        }
        ...
        /// then onward to its transform and all ancestor transforms recursively until
        /// a callback registered under 'eventName' is found in any of the objects.
        /// example signature: 'TargetEvent&lt;int, bool&gt;.SendUpwards'. NOTES:
        /// 1) only the first matching callback detected will execute. The event will fail
        /// if the scan reaches the scene root with no match found. 2) it is best to register
        /// _transforms_ and not other types of component for use with 'SendUpwards', since
        /// components will be ignored unless the event is sent specifically to the
        /// correct component.
        /// </summary>
        public static void SendUpwards(Component target, string eventName, T arg1, U arg2, TargetEventOptions options = TargetEventOptions.DontRequireReceiver)
        {
            retry : Delegate callback = TargetEventHandler.GetCallback(target, eventName, true, 2, options);
            if (callback == null)
            {
                TargetEventHandler.OnNoReceiver(eventName, options);
                return;
    ...
    /// (3 generic arguments).
    /// </summary>
    public static class TargetEvent<T, U, V>
    {

        /// <summary>
        /// registers a callback (method or delegate) with the target object.
        /// the callback can be triggered later by sending the event 'eventName'.
        /// example signature: 'TargetEvent&ltint, bool, float&gt.Register'
        /// </summary>
        public static void Register(object target, string eventName, Action<T, U, V> callback)
        {
            TargetEventHandler.Register(target, eventName, (Delegate) callback, 3);
        }
        ...
        /// 'TargetEventOptions.RequireReceiver' there will be an error if
        /// no such callback can be found.
        /// example signature: 'TargetEvent&lt;int, bool, float&gt;.Send'
        /// </summary>
        public static void Send(object target, string eventName, T arg1, U arg2, V arg3, TargetEventOptions options = TargetEventOptions.DontRequireReceiver)
        {
            retry : Delegate callback = TargetEventHandler.GetCallback(target, eventName, false, 3, options);
            if (callback == null)
            {
                TargetEventHandler.OnNoReceiver(eventName, options);
                return;
            ...
            try
            {
                ((Action<T, U, V>) callback).Invoke(arg1, arg2, arg3);
            }
            catch { eventName += "_"; goto retry; }
        }
        ...
        /// then onward to its transform and all ancestor transforms recursively until
        /// a callback registered under 'eventName' is found in any of the objects.
        /// example signature: 'TargetEvent&lt;int, bool, float&gt;.SendUpwards'. NOTES:
        /// 1) only the first matching callback detected will execute. The event will fail
        /// if the scan reaches the scene root with no match found. 2) it is best to register
        /// _transforms_ and not other types of component for use with 'SendUpwards', since
        /// components will be ignored unless the event is sent specifically to the
        /// correct component.
        /// </summary>
        public static void SendUpwards(Component target, string eventName, T arg1, U arg2, V arg3, TargetEventOptions options = TargetEventOptions.DontRequireReceiver)
        {
            retry : Delegate callback = TargetEventHandler.GetCallback(target, eventName, true, 3, options);
            if (callback == null)
            {
                TargetEventHandler.OnNoReceiver(eventName, options);
                return;
